...
<form action="<?php echo base_url('admin/laporanGaji/cetakLaporanGaji')?>" method="POST">
    <div class="card mx-auto mb-4" style="width: 45%">
        <div class="card-header bg-primary text-white">Filter Laporan Gaji Pegawai</div>
        ...
        <div class="card-body">
            ...
            <button type="submit" class="btn btn-primary w-100"><i class="fas fa-print pr-2"></i>Cetak Laporan Gaji</button>
        </div>
    </div>
</form>
</div>