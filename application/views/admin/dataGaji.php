<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form class="form-inline">
                ...
                <?php if (count($gaji) > 0) { ?>
                    <a href="<?php echo base_url('admin/dataPenggajian/cetakGaji?bulan=' . $bulan), '&tahun=' . $tahun ?>" class="btn btn-success mb-2 ml-3"><i class="fas fa-print pr-2"></i>Cetak daftar Gaji</a>
                <?php } else { ?>
                    <button type="button" class="btn btn-success mb-2 ml-3" data-toggle="modal" data-target="#exampleModal">
                        <i class="fas fa-print pr-2"></i>Cetak daftar Gaji
                    </button>
                <?php } ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <th class="text-white bg-secondary">NIK</th>
                    <th class="text-white bg-secondary">Nama Pegawai</th>
                    <th class="text-white bg-secondary">jenis Kelamin</th>
                    <th class="text-white bg-secondary">Jabatan</th>
                    ...
                    <th class="text-white bg-secondary">Potongan</th>
                    <th class="text-white bg-secondary">Total Gaji</th>
                </tr>
    ...
    <?php } else {
    ?> <span class="badge badge-danger"><i class="fas fa-info-circle pr-1"></i>Data Masih Absensi Kosong, silahkan input data kehadiran pada bulan dan tahun yang Anda pilih.</span>
    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Data Gaji Masih Kosong, silahkan input absensi terlebih dahulu pada blan dan tahun yang Anda pilih.
            </div>
