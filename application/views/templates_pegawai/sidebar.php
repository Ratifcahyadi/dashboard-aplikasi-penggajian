<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="bg-gradient-customize navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top  shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                        ...
                        <form class="d-none d-sm-inline-block form-inline mr-auto ">
                            <span class="fw-bold text-primary">PT INDONESIA BANGKIT</span>
